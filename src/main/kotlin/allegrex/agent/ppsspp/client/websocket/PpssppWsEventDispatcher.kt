...
import allegrex.agent.ppsspp.client.model.event.PpssppErrorEvent
import allegrex.agent.ppsspp.client.model.event.PpssppEvent
import allegrex.agent.ppsspp.client.model.event.PpssppGamePauseEvent
import allegrex.agent.ppsspp.client.model.event.PpssppGameQuitEvent
import allegrex.agent.ppsspp.client.model.event.PpssppGameResumeEvent
import allegrex.agent.ppsspp.client.model.event.PpssppGameStartEvent
import allegrex.agent.ppsspp.client.model.event.PpssppLogEvent
import allegrex.agent.ppsspp.client.model.event.ppssppEventMap
